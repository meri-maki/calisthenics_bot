...
const bot = new grammy_1.Bot("7817386534:AAEDBZoI7oUN3B6TD17Byr0M6ZJopW_76ek") // <-- put your bot token between the ""
const userSessions = {}
bot.command("start", (ctx) =>
    __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b
        const userId =
            ((_b = (_a = ctx.from) === null || _a === void 0 ? void 0 : _a.id) === null || _b === void 0
                ? void 0
                : _b.toString()) || ""
...
bot.command("reset", (ctx) =>
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (userSessions[userId])
            delete userSessions[
                ((_d = (_c = ctx.from) === null || _c === void 0 ? void 0 : _c.id) === null || _d === void 0
                    ? void 0
                    : _d.toString()) || ""
            ]
...
bot.callbackQuery("start_session", (ctx) =>
    __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b
        const userId =
            ((_b = (_a = ctx.from) === null || _a === void 0 ? void 0 : _a.id) === null || _b === void 0
...
bot.callbackQuery("next_exercise", (ctx) =>
    __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b
        const userId =
            ((_b = (_a = ctx.from) === null || _a === void 0 ? void 0 : _a.id) === null || _b === void 0
